...
データはまず、このブラウザ・端末内の IndexedDB に保存されます。「設定・データ管理」でSupabaseへログインすると、予定、記録、下書き、担当者、記録の選択肢、利用場所がSupabaseにも保存されます。同じメールアドレスとパスワードでログインしたPC・スマホでは、同じデータを確認・更新できます。
...
2. メールアドレスと8文字以上のパスワードを入力し、「初めての方」を押します。
3. 確認メールが届いた場合は、メール内の案内を完了してからログインします。
4. もう片方の端末でも、同じメールアドレスとパスワードで「ログインして同期」を押します。
